...
function ClienteCard({ cliente }) {
  ...
  return (
    <Card className="h-100 shadow-sm border-0 cliente-card">
      <Card.Body>
        <div className="d-flex justify-content-between align-items-start mb-2">
          <Card.Title className="fw-bold cliente-card-title mb-0 cliente-card-title">{cliente.ragioneSociale}</Card.Title>
        ...
        <Card.Text className="fw-semibold">Fatturato: {formattaImporto(cliente.fatturatoAnnuale)}</Card.Text>
